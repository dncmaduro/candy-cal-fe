...
- `VITE_BACKEND_URL`: base URL API backend. Có thể khai báo nhiều URL trong cùng 1 chuỗi, phân tách bằng dấu phẩy, ví dụ `https://api-primary.example.com,https://api-secondary.example.com`
